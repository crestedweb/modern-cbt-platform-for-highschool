...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form action="<?php echo e(route('admin.teacher.update', $teacher->id)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
