...
<div class="space-y-6">
    ...
    <a href="<?php echo e(route('admin.students')); ?>" class="block bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-3 rounded text-center font-semibold">Manage Students</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cbtplus\modern-cbt-platform-for-highschool\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>