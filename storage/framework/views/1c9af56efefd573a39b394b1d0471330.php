...
<body class="bg-gradient-to-br from-green-500 to-green-700 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Nigerian School Examination Portal</p>
        </div>
...
<?php /**PATH C:\Users\USER\Desktop\CBT PROJECT\nigerian-cbt-system\nigerian-cbt-system\resources\views/auth/login.blade.php ENDPATH**/ ?>